...
{% include figure.html
    ...
    caption='Color chanel values for different temperatures of black bodies'
%}
...
{% include figure.html
    ...
    caption='The brightness function $$f_k(x)$$ for some values of $$k$$. For the lights I have, $$k=\frac{1}{8}$$ looks the best.'
%}
